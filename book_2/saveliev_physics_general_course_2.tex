...
\cleardoublepage
%\input{02_electric_field_in_dielectrics}
\cleardoublepage
%\input{03_conductors_in_an_electric_field}
\cleardoublepage
%\input{04_energy_of_an_electric_field}
\cleardoublepage
%\input{05_steady_electric_current}
\cleardoublepage
%\input{06_magnetic_field_in_a_vacuum}
\cleardoublepage
%\input{07_magnetic_field_in_a_substance}
\cleardoublepage
%\input{08_electromagnetic_induction}
\cleardoublepage
%\input{09_maxwells_equations}
\cleardoublepage
%\input{10_motion_of_charged_particles_in_E_and_B_fields}
\cleardoublepage
%\input{11_classical_theory_of_electrical_conductance_metals}
\cleardoublepage
%\input{12_electric_current_in_gases}
\cleardoublepage
%\input{13_electrical_oscillations}
\cleardoublepage

%\part{WAVES}\label{part:B}
\cleardoublepage
%\input{14_elastics_waves}
\cleardoublepage
%\input{15_electromagnetic_waves}
\cleardoublepage
...
%\input{16_general}
\cleardoublepage
%\input{17_interference_of_light}
\cleardoublepage
%\input{18_diffraction_of_light}
\cleardoublepage
%\input{19_polarization_of_light}
\cleardoublepage
%\input{20_interaction_of_emw_with_substance}
\cleardoublepage
%\input{21_moving_media_optics}
\cleardoublepage
%\input{A_appendices}
\printindex
